...
export const description: INodeProperties[] = [
  {
    ...
    description: 'Returns current Ethereum gas prices (slow, standard, fast).',
  },
];
...
export async function execute(
  ...
  const gasPrice = await curveApiRequest.call(this, {
    endpoint: PROTOCOL_ENDPOINTS.GET_GAS_PRICE,
  }) as IDataObject;
