...
export const description: INodeProperties[] = [
  {
    ...
    displayOptions: {
      show: {
        resource: ['crvusd'],
        operation: ['getScrvusdSupply'],
      },
    },
    // eslint-disable-next-line n8n-nodes-base/node-param-description-unneeded-backticks
    description: 'Returns the total supply of scrvUSD (savings/yield-bearing version of crvUSD).',
  },
];
...
export async function execute(
  ...
  const supply = await curveApiRequest.call(this, {
    endpoint: CRVUSD_ENDPOINTS.GET_SCRVUSD_SUPPLY,
  }) as IDataObject;
